...
from .views import HubList, HubJoined, HubModerating, HubOwned, HubByID, HubCreate, HubUpdate, HubDelete, HubAddMember, HubAddPendingMember, HubAddMemberFromPending, HubRemoveMember, HubRemovePendingMember, HubRemoveMemberFromPending, HubAddModerator, HubRemoveModerator, HubKickMember, HubPosts, FilterHubs, HubTagUpdateView
...
urlpatterns = [
        ...
        path('hubs/<int:id>/update/tags/', HubTagUpdateView.as_view(), name='update-hub-tags'),
]
